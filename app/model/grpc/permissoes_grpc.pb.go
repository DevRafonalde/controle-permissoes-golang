...
type PermissoesClient interface {
	FindAllPermissoes(ctx context.Context, in *RequestAllPaginado, opts ...grpc.CallOption) (*ListaPermissoes, error)
...
func (c *permissoesClient) FindAllPermissoes(ctx context.Context, in *RequestAllPaginado, opts ...grpc.CallOption) (*ListaPermissoes, error) {
...
type PermissoesServer interface {
	FindAllPermissoes(context.Context, *RequestAllPaginado) (*ListaPermissoes, error)
...
func (UnimplementedPermissoesServer) FindAllPermissoes(context.Context, *RequestAllPaginado) (*ListaPermissoes, error) {
...
func _Permissoes_FindAllPermissoes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PermissoesServer).FindAllPermissoes(ctx, req.(*RequestAllPaginado))
	}
