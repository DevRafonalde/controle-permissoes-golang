...
type PerfisClient interface {
	FindAllPerfis(ctx context.Context, in *RequestAllPaginado, opts ...grpc.CallOption) (*ListaPerfis, error)
	...
	DesativarPerfil(ctx context.Context, in *PerfilDelete, opts ...grpc.CallOption) (*ResponseBool, error)
}
...
func (c *perfisClient) FindAllPerfis(ctx context.Context, in *RequestAllPaginado, opts ...grpc.CallOption) (*ListaPerfis, error) {
...
func (c *perfisClient) DesativarPerfil(ctx context.Context, in *PerfilDelete, opts ...grpc.CallOption) (*ResponseBool, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResponseBool)
...
type PerfisServer interface {
	FindAllPerfis(context.Context, *RequestAllPaginado) (*ListaPerfis, error)
	...
	DesativarPerfil(context.Context, *PerfilDelete) (*ResponseBool, error)
...
func (UnimplementedPerfisServer) FindAllPerfis(context.Context, *RequestAllPaginado) (*ListaPerfis, error) {
...
func (UnimplementedPerfisServer) DesativarPerfil(context.Context, *PerfilDelete) (*ResponseBool, error) {
...
func _Perfis_FindAllPerfis_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PerfisServer).FindAllPerfis(ctx, req.(*RequestAllPaginado))
	}
...
func _Perfis_DesativarPerfil_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PerfisServer).DesativarPerfil(ctx, req.(*PerfilDelete))
	}
	return interceptor(ctx, in, info, handler)
}
